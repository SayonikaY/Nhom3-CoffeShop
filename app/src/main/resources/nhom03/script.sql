...
(
    ...
    LoaiSanPham NVARCHAR(20)   NOT NULL
                               CHECK (LoaiSanPham IN (N'Đồ uống', N'Đồ ăn', N'Khác')),
    DonGia      DECIMAL(10, 2) NOT NULL,
    MoTa        NVARCHAR(MAX)  NULL,
    HinhAnh     NVARCHAR(255)  NULL,
    TrangThai   NVARCHAR(10)   NOT NULL DEFAULT (N'Còn')
                               CHECK (TrangThai IN (N'Còn', N'Hết', N'Ngưng'))
);
GO
...
(
    ...
    TrangThai NVARCHAR(20)  NOT NULL DEFAULT (N'Trống')
                            CHECK (TrangThai IN (N'Trống', N'Đang sử dụng', N'Đặt trước'))
);
GO
...
(
    ...
    MaChiTietHD      INT            NOT NULL FOREIGN KEY REFERENCES ChiTietHoaDon (MaChiTiet),
    MaTopping        INT            NOT NULL FOREIGN KEY REFERENCES Topping (MaTopping),
...
(
    ...
    MaPhieuNhap   INT            NOT NULL FOREIGN KEY REFERENCES PhieuNhapKho (MaPhieuNhap),
...
(
    ...
    MaPhieuXuat   INT            NOT NULL FOREIGN KEY REFERENCES PhieuXuatKho (MaPhieuXuat),
    MaNguyenLieu  INT            NOT NULL FOREIGN KEY REFERENCES NguyenLieu (MaNguyenLieu),
    SoLuong       DECIMAL(10, 2) NOT NULL
);
GO
...
INSERT INTO Ban (TenBan, TrangThai, GhiChu)
VALUES (N'Bàn 1', N'Trống', N'Bàn gần cửa sổ'),
...
INSERT INTO SanPham (TenSanPham, LoaiSanPham, DonGia, MoTa, HinhAnh, TrangThai)
VALUES (N'Cà phê đen', N'Đồ uống', 25000, N'Cà phê đen truyền thống', N'ca-phe-den.jpg', N'Còn'),
...
INSERT INTO Topping (TenTopping, DonGia, MoTa, TrangThai)
VALUES (N'Trân châu đen', 10000, N'Trân châu đường đen', N'Còn'),
...
INSERT INTO NguyenLieu (TenNguyenLieu, DonViTinh, SoLuongTon, DonGiaNhap)
VALUES (N'Cà phê hạt', N'kg', 50, 200000),
...
VALUES ('2024-03-01', 500000, N'Nhập hàng từ nhà cung cấp A'),
...
INSERT INTO PhieuXuatKho (NgayXuat, LyDo, GhiChu)
VALUES ('2024-03-01', N'Xuất hàng cho quán A', N'Xuất nguyên liệu pha chế'),
...
INSERT INTO HoaDon (MaBan, NgayLap, TongTien, GiamGia, TrangThai)
VALUES (1, '2024-03-01 08:15:00', 150000, 10000, N'Đã thanh toán'),
...
INSERT INTO ChiTietHoaDon (MaHoaDon, MaSanPham, SoLuong, DonGia, GhiChu)
VALUES (1, 1, 2, 25000, N'Đá ít'),
...
INSERT INTO ChiTietTopping (MaChiTietHD, MaTopping, SoLuong, DonGia)
VALUES (1, 1, 1, 10000),
       (2, 4, 1, 15000),
       (3, 2, 2, 10000),
       (5, 5, 1, 12000),
...
INSERT INTO ChiTietPhieuXuat (MaPhieuXuat, MaNguyenLieu, SoLuong)
VALUES (1, 1, 2),
       (1, 2, 1),
       (1, 3, 2),
       (2, 4, 0.5),
